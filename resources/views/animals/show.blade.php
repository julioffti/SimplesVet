...
<a class="btn btn-danger" href="{{ route('animals.destroy',['animal' => $animal->id]) }}"
   onclick="event.preventDefault();if(confirm('Deseja excluir este animal??')){document.getElementById('form-deletar-{{$animal->id}}').submit();}"><span class="glyphicon glyphicon-trash">&nbsp;Excluir</span></a>
